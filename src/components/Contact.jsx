    ...
    <section id="contact" className="py-24 border-t border-[var(--color-border)]">
      <div className="max-w-portfolio mx-auto px-6">
        <div className="max-w-xl">
          <h2 className="text-xs font-medium tracking-widest uppercase text-[var(--color-text-tertiary)] mb-3 section-reveal">
            Contact
          </h2>
          <p className="text-3xl sm:text-4xl font-bold tracking-tight mb-4 section-reveal">
            Let's build something useful.
          </p>
          <p className="text-[var(--color-text-secondary)] leading-relaxed mb-8 section-reveal">
